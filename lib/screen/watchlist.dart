                  ...
                  child: Row(
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: Image.network(
                          movie
                              .posterUrl, // Langsung pakai atribut dari objek Movie
                          width: 80,
                          height: 120,
                          fit: BoxFit.cover,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              movie
                                  .title, // Langsung pakai atribut dari objek Movie
                            ...
                            Text(
                              movie.genres.join(
                                ', ',
                              ), // Gabungkan genre menjadi satu string
                              style: const TextStyle(
                                fontSize: 15,
                                color: Colors.black,
                                fontWeight: FontWeight.bold,
                            ...
                            Text(
                              movie
                                  .duration, // Langsung pakai atribut dari objek Movie
                              style: TextStyle(
                                fontSize: 14,
