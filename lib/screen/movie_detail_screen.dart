...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Gunakan Consumer untuk mendapatkan akses ke WatchlistProvider
    return Consumer<WatchlistProvider>(
      builder: (context, watchlistProvider, child) {
        // Cek apakah film ini sudah ada di watchlist
        final bool isInWatchlist =
            watchlistProvider.isMovieInWatchlist(movie.id.toString());
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            actions: [
              ...
              IconButton(
                icon: Icon(
                  // Ubah ikon berdasarkan status watchlist
                  isInWatchlist ? Icons.bookmark_added : Icons.bookmark_add_outlined,
                  size: 28,
                ),
                onPressed: () {
                  // Panggil fungsi untuk menambah/menghapus dari watchlist
